...
const modalTabList: ModalTab[] = [
    { key: "EMP", menuTitle: "Employé", title: "Employé", component: <EmployeList /> },
    { key: "PE", menuTitle: "Pole Emploi", title: "Pole Emploi", component: <PoleEmploye /> },
];
            ...
            <div className="flex flex-row">
                ...
                {modalTabList
                    ...
                    .map((modalTab: ModalTab) => (
                        <div className="px-8 pt-2 pb-8 w-full">
                            <h3 className="font-bold text-lg mb-6">{modalTab.title}</h3>
                            {modalTab.component}
                        </div>
                    ))}
            </div>
